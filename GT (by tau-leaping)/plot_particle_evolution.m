...
y1=SIRPF_particles(k,3,:);
x1=SIRPF_particles(k,4,:);
y2=RPF_particles(k,3,:);
x2=RPF_particles(k,4,:);

subplot(2,3, (k-1)/96+1);
...
hold on
plot(K(4),K(3),'black.','Markersize',20);
...
title_string=sprintf('Time: %d mins',(k-1)*0.5);
