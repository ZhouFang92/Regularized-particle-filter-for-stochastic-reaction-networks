...
if j==1
   ...
   elseif i==5
      ...
      ylabel('$k''_6$','Interpreter','latex','FontSize',10)
   end
end
...
if i==6
   ...
   elseif j==4
      ...
      xlabel('$k''_5$','Interpreter','latex','FontSize',10) 
   end
end

if i==6 && j==5
    legend([true_value,scatter1,scatter2],{'True value','RPF','SIRPF'},'Location','northeast','FontSize',15,'Orientation','vertical');
end
...
for i=1:6
   ...
   true_value=plot(K(i)*ones(11,1),[0:1000:10000],'black','LineWidth',1.1);
   hold on
